        ...
        <div className="HeroSection left-[273px] top-[150px] absolute flex-col justify-start items-center gap-[23px] inline-flex">
          <div className="Frame2 flex-col justify-start items-center gap-[32px] flex">
            <div className="Frame1 justify-center items-center gap-11 inline-flex">
              <div className="ProfNet text-purple-500 text-5xl font-extrabold font-['Archivo'] tracking-[2.88px] sm:text-8xl">
                PROF NET
              </div>
              <div className="logo">
                {/* //todo Logo */}
            ...
            <div className="Tagline p-2.5 justify-center items-center gap-5 flex flex-col">
              <div className="text-center ">
                <span className="text-white text-sm font-bold font-['Archivo'] tracking-[2.60px] sm:text-[52px]">
                  Lovely professional University one
                  <br />
                  stop platform for{" "}
                </span>
                ...
                <span className="text-white text-[52px] font-bold font-['Archivo'] tracking-[2.60px]">
                  insight
                </span>
              </div>
            </div>
          ...
          <div className="Frame3 flex-col justify-start items-center gap-[30px] flex">
            <Link href="../loginpage">
              <div className="Button px-10 py-3 bg-stone-900 rounded-[15px] border border-white justify-center items-center gap-2.5 inline-flex">
                <button className="Login text-zinc-100 text-xl font-normal font-['Roboto'] tracking-wide">
                  Login
                </button>
              </div>
            </Link>
